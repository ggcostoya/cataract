...
This is an example R package I created called `kurama`. This `kurama.Rproj` file is the source to all of it. If you go to the folder where you created the package and click on it an R session with your project name will appear. Notice also that on the top right hand side it doesn't say `Project:(None)` anymore! The name of your package should appear up there. 
...
### **Integrate your R package with Git & GitHub**
